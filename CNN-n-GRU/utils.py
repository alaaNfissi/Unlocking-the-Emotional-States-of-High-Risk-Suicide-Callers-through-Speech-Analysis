...
merged_data_folder = 'merged DATA FOLDER LOCATION'
merged_data_experiments_folder = 'EXPERIMENTS FOLDER LOCATION'
...
def transform_data(data):
    data_dir = os.path.abspath(merged_data_folder+'/MERGED_DATA')
    path_lst = []
    for i in data['path']:
